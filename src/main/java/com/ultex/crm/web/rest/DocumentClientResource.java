...
public class DocumentClientResource {
     ...
     */
    @GetMapping("")
    public ResponseEntity<List<DocumentClientDTO>> getAllDocumentClients(
        @org.springdoc.core.annotations.ParameterObject Pageable pageable
    ) {
        LOG.debug("REST request to get a page of DocumentClients");
        Page<DocumentClientDTO> page = documentClientService.findAll(pageable);
