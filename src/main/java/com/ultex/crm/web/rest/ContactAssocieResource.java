...
public class ContactAssocieResource {
     ...
     */
    @GetMapping("")
    public ResponseEntity<List<ContactAssocieDTO>> getAllContactAssocies(
        @org.springdoc.core.annotations.ParameterObject Pageable pageable
    ) {
        LOG.debug("REST request to get a page of ContactAssocies");
        Page<ContactAssocieDTO> page = contactAssocieService.findAll(pageable);
