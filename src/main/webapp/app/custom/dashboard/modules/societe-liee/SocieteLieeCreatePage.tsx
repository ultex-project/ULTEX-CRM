...
import { createEntity, reset } from 'app/entities/societe-liee/societe-liee.reducer';
...
const FORM_ID = 'societe-liee-create-form';

const SocieteLieeCreatePage = () => {
  ...
  const handleChange =
    (field: keyof SocieteLieeFormState) => (event: React.ChangeEvent<HTMLInputElement | HTMLSelectElement | HTMLTextAreaElement>) => {
  ...
  const handleSubmit = (event: React.FormEvent<HTMLFormElement>) => {
    ...
    dispatch(createEntity(buildPayload()));
  };
  ...
  return (
    <div className="societe-liee-create-page">
      <Card className="shadow-sm border-0">
        <CardHeader className="bg-white d-flex justify-content-between align-items-center">
          <div>
            <h5 className="mb-1">Créer une société liée</h5>
            <p className="mb-0 text-muted">Renseignez les informations de la société liée.</p>
          </div>
            ...
            <Row className="g-4">
              ...
              <Col md="6">
                <FormGroup>
                  ...
                  <Input id="societe-rc" name="rc" value={formValues.rc} onChange={handleChange('rc')} placeholder="Registre de commerce" />
                </FormGroup>
              </Col>
              <Col md="6">
                <FormGroup>
...
export default SocieteLieeCreatePage;
