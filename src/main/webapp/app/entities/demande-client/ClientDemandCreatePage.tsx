...
const INCOTERM_OPTIONS = ['EXW', 'FOB', 'CIF', 'DDP'] as const;
const DEVISE_OPTIONS = ['MAD', 'USD', 'EUR', 'CNY'] as const;
...
const ClientDemandCreatePage = () => {
  ...
  const validate = () => {
    ...
    if (!formValues.incoterm) {
      nextErrors.incoterm = translate('crmApp.demandeClient.create.errors.incoterm');
    }
    if (!formValues.devise) {
      nextErrors.devise = translate('crmApp.demandeClient.create.errors.devise');
    }
            ...
            <Row className="g-4">
              ...
              <Col md="4">
                <FormGroup>
                  ...
                  <Input id="demande-incoterm" type="select" value={formValues.incoterm} onChange={handleChange('incoterm')}>
                    <option value="">{translate('crmApp.demandeClient.create.selectPlaceholder')}</option>
              ...
              <Col md="4">
                <FormGroup>
                  ...
                  <Input id="demande-devise" type="select" value={formValues.devise} onChange={handleChange('devise')}>
                    <option value="">{translate('crmApp.demandeClient.create.selectPlaceholder')}</option>
