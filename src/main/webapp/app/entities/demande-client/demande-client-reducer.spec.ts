...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DEMANDECLIENT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DEMANDECLIENT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DEMANDECLIENT actions', async () => {
      const arg = { id: 10736 };
    ...
    it('dispatches UPDATE_DEMANDECLIENT actions', async () => {
      const arg = { id: 10736 };
    ...
    it('dispatches PARTIAL_UPDATE_DEMANDECLIENT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DEMANDECLIENT actions', async () => {
      const arg = 42666;
