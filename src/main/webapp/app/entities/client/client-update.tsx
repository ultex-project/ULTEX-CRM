        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              />
              <ValidatedField label={translate('crmApp.client.phone')} id="client-phone" name="phone" data-cy="phone" type="text" />
              <ValidatedField label={translate('crmApp.client.company')} id="client-company" name="company" data-cy="company" type="text" />
