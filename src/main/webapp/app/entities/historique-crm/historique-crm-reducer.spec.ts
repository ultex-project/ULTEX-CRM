...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_HISTORIQUECRM_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_HISTORIQUECRM actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_HISTORIQUECRM actions', async () => {
      const arg = { id: 8557 };
    ...
    it('dispatches UPDATE_HISTORIQUECRM actions', async () => {
      const arg = { id: 8557 };
    ...
    it('dispatches PARTIAL_UPDATE_HISTORIQUECRM actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_HISTORIQUECRM actions', async () => {
      const arg = 42666;
