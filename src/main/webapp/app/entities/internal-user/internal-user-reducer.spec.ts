...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INTERNALUSER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_INTERNALUSER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_INTERNALUSER actions', async () => {
      const arg = { id: 31595 };
    ...
    it('dispatches UPDATE_INTERNALUSER actions', async () => {
      const arg = { id: 31595 };
    ...
    it('dispatches PARTIAL_UPDATE_INTERNALUSER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_INTERNALUSER actions', async () => {
      const arg = 42666;
