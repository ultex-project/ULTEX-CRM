...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './devise.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DEVISE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DEVISE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DEVISE actions', async () => {
      const arg = { id: 8760 };
    ...
    it('dispatches UPDATE_DEVISE actions', async () => {
      const arg = { id: 8760 };
    ...
    it('dispatches PARTIAL_UPDATE_DEVISE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DEVISE actions', async () => {
      const arg = 42666;
