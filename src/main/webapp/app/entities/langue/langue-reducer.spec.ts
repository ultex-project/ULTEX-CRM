...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './langue.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LANGUE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_LANGUE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_LANGUE actions', async () => {
      const arg = { id: 10103 };
    ...
    it('dispatches UPDATE_LANGUE actions', async () => {
      const arg = { id: 10103 };
    ...
    it('dispatches PARTIAL_UPDATE_LANGUE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_LANGUE actions', async () => {
      const arg = 42666;
