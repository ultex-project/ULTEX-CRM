...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CONTACTASSOCIE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CONTACTASSOCIE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CONTACTASSOCIE actions', async () => {
      const arg = { id: 7783 };
    ...
    it('dispatches UPDATE_CONTACTASSOCIE actions', async () => {
      const arg = { id: 7783 };
    ...
    it('dispatches PARTIAL_UPDATE_CONTACTASSOCIE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CONTACTASSOCIE actions', async () => {
      const arg = 42666;
