...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_KYCCLIENT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_KYCCLIENT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_KYCCLIENT actions', async () => {
      const arg = { id: 21375 };
    ...
    it('dispatches UPDATE_KYCCLIENT actions', async () => {
      const arg = { id: 21375 };
    ...
    it('dispatches PARTIAL_UPDATE_KYCCLIENT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_KYCCLIENT actions', async () => {
      const arg = 42666;
