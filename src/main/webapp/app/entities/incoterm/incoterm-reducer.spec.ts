...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './incoterm.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INCOTERM_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_INCOTERM actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_INCOTERM actions', async () => {
      const arg = { id: 21773 };
    ...
    it('dispatches UPDATE_INCOTERM actions', async () => {
      const arg = { id: 21773 };
    ...
    it('dispatches PARTIAL_UPDATE_INCOTERM actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_INCOTERM actions', async () => {
      const arg = 42666;
