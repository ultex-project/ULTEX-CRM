...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './prospect.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PROSPECT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PROSPECT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PROSPECT actions', async () => {
      const arg = { id: 15410 };
    ...
    it('dispatches UPDATE_PROSPECT actions', async () => {
      const arg = { id: 15410 };
    ...
    it('dispatches PARTIAL_UPDATE_PROSPECT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PROSPECT actions', async () => {
      const arg = 42666;
