...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SOCIETELIEE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SOCIETELIEE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SOCIETELIEE actions', async () => {
      const arg = { id: 2191 };
    ...
    it('dispatches UPDATE_SOCIETELIEE actions', async () => {
      const arg = { id: 2191 };
    ...
    it('dispatches PARTIAL_UPDATE_SOCIETELIEE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SOCIETELIEE actions', async () => {
      const arg = 42666;
