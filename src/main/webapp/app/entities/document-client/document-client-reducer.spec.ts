...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DOCUMENTCLIENT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DOCUMENTCLIENT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DOCUMENTCLIENT actions', async () => {
      const arg = { id: 25361 };
    ...
    it('dispatches UPDATE_DOCUMENTCLIENT actions', async () => {
      const arg = { id: 25361 };
    ...
    it('dispatches PARTIAL_UPDATE_DOCUMENTCLIENT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DOCUMENTCLIENT actions', async () => {
      const arg = 42666;
