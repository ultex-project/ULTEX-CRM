...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RAPPELAGENT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_RAPPELAGENT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_RAPPELAGENT actions', async () => {
      const arg = { id: 23067 };
    ...
    it('dispatches UPDATE_RAPPELAGENT actions', async () => {
      const arg = { id: 23067 };
    ...
    it('dispatches PARTIAL_UPDATE_RAPPELAGENT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_RAPPELAGENT actions', async () => {
      const arg = 42666;
