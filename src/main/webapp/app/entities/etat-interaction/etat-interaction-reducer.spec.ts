...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ETATINTERACTION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ETATINTERACTION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ETATINTERACTION actions', async () => {
      const arg = { id: 20908 };
    ...
    it('dispatches UPDATE_ETATINTERACTION actions', async () => {
      const arg = { id: 20908 };
    ...
    it('dispatches PARTIAL_UPDATE_ETATINTERACTION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ETATINTERACTION actions', async () => {
      const arg = 42666;
