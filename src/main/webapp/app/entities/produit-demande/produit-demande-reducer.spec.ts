...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PRODUITDEMANDE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PRODUITDEMANDE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PRODUITDEMANDE actions', async () => {
      const arg = { id: 25238 };
    ...
    it('dispatches UPDATE_PRODUITDEMANDE actions', async () => {
      const arg = { id: 25238 };
    ...
    it('dispatches PARTIAL_UPDATE_PRODUITDEMANDE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PRODUITDEMANDE actions', async () => {
      const arg = 42666;
