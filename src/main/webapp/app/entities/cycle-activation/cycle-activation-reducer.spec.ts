...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CYCLEACTIVATION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CYCLEACTIVATION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CYCLEACTIVATION actions', async () => {
      const arg = { id: 2426 };
    ...
    it('dispatches UPDATE_CYCLEACTIVATION actions', async () => {
      const arg = { id: 2426 };
    ...
    it('dispatches PARTIAL_UPDATE_CYCLEACTIVATION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CYCLEACTIVATION actions', async () => {
      const arg = 42666;
