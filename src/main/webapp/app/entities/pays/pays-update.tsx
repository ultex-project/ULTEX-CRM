...
import { createEntity, getEntity, reset, updateEntity } from './pays.reducer';
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="crmApp.pays.home.createOrEditLabel" data-cy="PaysCreateUpdateHeading">
            <Translate contentKey="crmApp.pays.home.createOrEditLabel">Create or edit a Pays</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('crmApp.pays.code')}
                id="pays-code"
                name="code"
                data-cy="code"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('crmApp.pays.nom')}
                id="pays-nom"
                name="nom"
                data-cy="nom"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('crmApp.pays.indicatif')}
                id="pays-indicatif"
                name="indicatif"
                data-cy="indicatif"
                type="text"
