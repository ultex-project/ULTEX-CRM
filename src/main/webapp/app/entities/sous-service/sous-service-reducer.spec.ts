...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SOUSSERVICE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SOUSSERVICE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SOUSSERVICE actions', async () => {
      const arg = { id: 14083 };
    ...
    it('dispatches UPDATE_SOUSSERVICE actions', async () => {
      const arg = { id: 14083 };
    ...
    it('dispatches PARTIAL_UPDATE_SOUSSERVICE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SOUSSERVICE actions', async () => {
      const arg = 42666;
