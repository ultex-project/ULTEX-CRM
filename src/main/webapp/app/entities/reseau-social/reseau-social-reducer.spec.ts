...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RESEAUSOCIAL_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_RESEAUSOCIAL actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_RESEAUSOCIAL actions', async () => {
      const arg = { id: 4588 };
    ...
    it('dispatches UPDATE_RESEAUSOCIAL actions', async () => {
      const arg = { id: 4588 };
    ...
    it('dispatches PARTIAL_UPDATE_RESEAUSOCIAL actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_RESEAUSOCIAL actions', async () => {
      const arg = 42666;
